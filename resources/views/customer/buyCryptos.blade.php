                  ...
                  <div class="input-group mb-3" style="margin-left:20px">
                    <div>
                      <p style="font-weight:bold;font-size:15px">
                        The contents of your wallets is : 
                      </p>
                          {{$value->credit}} {{$value->symbol}}
                    </div>
                    <div class="input-group mb-3">
                      <input class="form-control" id="quantity" name="quantity" type="hidden" value="{{$value->credit}}"placeholder="credit">
                    </div>
                @endforeach
                      <div class="form-group">
                        <label style="margin-left:20px">
                          Select the currency to buy: 
                        </label>
